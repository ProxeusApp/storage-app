...
// CreateFileDefinedSigners is a paid mutator transaction binding the contract method 0x4bb12c19.
//
// Solidity: function createFileDefinedSigners(hash bytes32, definedSigners address[], expiry uint256, replacesFile bytes32, prvs address[], xesAmount uint256) returns()
func (_ProxeusFSContract *ProxeusFSContractTransactor) CreateFileDefinedSigners(opts *bind.TransactOpts, hash [32]byte, definedSigners []common.Address, expiry *big.Int, replacesFile [32]byte, prvs []common.Address, xesAmount *big.Int) (*types.Transaction, error) {
	return _ProxeusFSContract.contract.Transact(opts, "createFileDefinedSigners", hash, definedSigners, expiry, replacesFile, prvs, xesAmount)
}

// CreateFileDefinedSigners is a paid mutator transaction binding the contract method 0x4bb12c19.
//
// Solidity: function createFileDefinedSigners(hash bytes32, definedSigners address[], expiry uint256, replacesFile bytes32, prvs address[], xesAmount uint256) returns()
func (_ProxeusFSContract *ProxeusFSContractSession) CreateFileDefinedSigners(hash [32]byte, definedSigners []common.Address, expiry *big.Int, replacesFile [32]byte, prvs []common.Address, xesAmount *big.Int) (*types.Transaction, error) {
	return _ProxeusFSContract.Contract.CreateFileDefinedSigners(&_ProxeusFSContract.TransactOpts, hash, definedSigners, expiry, replacesFile, prvs, xesAmount)
}

// CreateFileDefinedSigners is a paid mutator transaction binding the contract method 0x4bb12c19.
//
// Solidity: function createFileDefinedSigners(hash bytes32, definedSigners address[], expiry uint256, replacesFile bytes32, prvs address[], xesAmount uint256) returns()
func (_ProxeusFSContract *ProxeusFSContractTransactorSession) CreateFileDefinedSigners(hash [32]byte, definedSigners []common.Address, expiry *big.Int, replacesFile [32]byte, prvs []common.Address, xesAmount *big.Int) (*types.Transaction, error) {
	return _ProxeusFSContract.Contract.CreateFileDefinedSigners(&_ProxeusFSContract.TransactOpts, hash, definedSigners, expiry, replacesFile, prvs, xesAmount)
}

// CreateFileShared is a paid mutator transaction binding the contract method 0x373a275c.
//
// Solidity: function createFileShared(hash bytes32, mandatorySigners uint256, expiry uint256, replacesFile bytes32, prvs address[], readers address[], xesAmount uint256) returns()
func (_ProxeusFSContract *ProxeusFSContractTransactor) CreateFileShared(opts *bind.TransactOpts, hash [32]byte, mandatorySigners *big.Int, expiry *big.Int, replacesFile [32]byte, prvs []common.Address, readers []common.Address, xesAmount *big.Int) (*types.Transaction, error) {
	return _ProxeusFSContract.contract.Transact(opts, "createFileShared", hash, mandatorySigners, expiry, replacesFile, prvs, readers, xesAmount)
}

// CreateFileShared is a paid mutator transaction binding the contract method 0x373a275c.
//
// Solidity: function createFileShared(hash bytes32, mandatorySigners uint256, expiry uint256, replacesFile bytes32, prvs address[], readers address[], xesAmount uint256) returns()
func (_ProxeusFSContract *ProxeusFSContractSession) CreateFileShared(hash [32]byte, mandatorySigners *big.Int, expiry *big.Int, replacesFile [32]byte, prvs []common.Address, readers []common.Address, xesAmount *big.Int) (*types.Transaction, error) {
	return _ProxeusFSContract.Contract.CreateFileShared(&_ProxeusFSContract.TransactOpts, hash, mandatorySigners, expiry, replacesFile, prvs, readers, xesAmount)
}

// CreateFileShared is a paid mutator transaction binding the contract method 0x373a275c.
//
// Solidity: function createFileShared(hash bytes32, mandatorySigners uint256, expiry uint256, replacesFile bytes32, prvs address[], readers address[], xesAmount uint256) returns()
func (_ProxeusFSContract *ProxeusFSContractTransactorSession) CreateFileShared(hash [32]byte, mandatorySigners *big.Int, expiry *big.Int, replacesFile [32]byte, prvs []common.Address, readers []common.Address, xesAmount *big.Int) (*types.Transaction, error) {
	return _ProxeusFSContract.Contract.CreateFileShared(&_ProxeusFSContract.TransactOpts, hash, mandatorySigners, expiry, replacesFile, prvs, readers, xesAmount)
}
...
// CreateFileUndefinedSigners is a paid mutator transaction binding the contract method 0xbb9103d0.
//
// Solidity: function createFileUndefinedSigners(hash bytes32, mandatorySigners uint256, expiry uint256, replacesFile bytes32, prvs address[], xesAmount uint256) returns()
func (_ProxeusFSContract *ProxeusFSContractTransactor) CreateFileUndefinedSigners(opts *bind.TransactOpts, hash [32]byte, mandatorySigners *big.Int, expiry *big.Int, replacesFile [32]byte, prvs []common.Address, xesAmount *big.Int) (*types.Transaction, error) {
	return _ProxeusFSContract.contract.Transact(opts, "createFileUndefinedSigners", hash, mandatorySigners, expiry, replacesFile, prvs, xesAmount)
}

// CreateFileUndefinedSigners is a paid mutator transaction binding the contract method 0xbb9103d0.
//
// Solidity: function createFileUndefinedSigners(hash bytes32, mandatorySigners uint256, expiry uint256, replacesFile bytes32, prvs address[], xesAmount uint256) returns()
func (_ProxeusFSContract *ProxeusFSContractSession) CreateFileUndefinedSigners(hash [32]byte, mandatorySigners *big.Int, expiry *big.Int, replacesFile [32]byte, prvs []common.Address, xesAmount *big.Int) (*types.Transaction, error) {
	return _ProxeusFSContract.Contract.CreateFileUndefinedSigners(&_ProxeusFSContract.TransactOpts, hash, mandatorySigners, expiry, replacesFile, prvs, xesAmount)
}

// CreateFileUndefinedSigners is a paid mutator transaction binding the contract method 0xbb9103d0.
//
// Solidity: function createFileUndefinedSigners(hash bytes32, mandatorySigners uint256, expiry uint256, replacesFile bytes32, prvs address[], xesAmount uint256) returns()
func (_ProxeusFSContract *ProxeusFSContractTransactorSession) CreateFileUndefinedSigners(hash [32]byte, mandatorySigners *big.Int, expiry *big.Int, replacesFile [32]byte, prvs []common.Address, xesAmount *big.Int) (*types.Transaction, error) {
	return _ProxeusFSContract.Contract.CreateFileUndefinedSigners(&_ProxeusFSContract.TransactOpts, hash, mandatorySigners, expiry, replacesFile, prvs, xesAmount)
}
...
// ProxeusFSContractPaymentReceivedIterator is returned from FilterPaymentReceived and is used to iterate over the raw logs and unpacked data for PaymentReceived events raised by the ProxeusFSContract contract.
type ProxeusFSContractPaymentReceivedIterator struct {
	Event *ProxeusFSContractPaymentReceived // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ProxeusFSContractPaymentReceivedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ProxeusFSContractPaymentReceived)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ProxeusFSContractPaymentReceivedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ProxeusFSContractPaymentReceivedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ProxeusFSContractPaymentReceived represents a PaymentReceived event raised by the ProxeusFSContract contract.
type ProxeusFSContractPaymentReceived struct {
	Hash            [32]byte
	XesAmount       *big.Int
...
// FilterPaymentReceived is a free log retrieval operation binding the contract event 0xa4f4c06ed2a22ae361ecbb5739e1e41869cd56d60d4d6dc236568ac62de5d6c8.
//
// Solidity: e PaymentReceived(hash bytes32, xesAmount uint256, storageProvider address)
func (_ProxeusFSContract *ProxeusFSContractFilterer) FilterPaymentReceived(opts *bind.FilterOpts) (*ProxeusFSContractPaymentReceivedIterator, error) {

	logs, sub, err := _ProxeusFSContract.contract.FilterLogs(opts, "PaymentReceived")
	if err != nil {
		return nil, err
	}
	return &ProxeusFSContractPaymentReceivedIterator{contract: _ProxeusFSContract.contract, event: "PaymentReceived", logs: logs, sub: sub}, nil
}

// WatchPaymentReceived is a free log subscription operation binding the contract event 0xa4f4c06ed2a22ae361ecbb5739e1e41869cd56d60d4d6dc236568ac62de5d6c8.
//
// Solidity: e PaymentReceived(hash bytes32, xesAmount uint256, storageProvider address)
func (_ProxeusFSContract *ProxeusFSContractFilterer) WatchPaymentReceived(opts *bind.WatchOpts, sink chan<- *ProxeusFSContractPaymentReceived) (event.Subscription, error) {

	logs, sub, err := _ProxeusFSContract.contract.WatchLogs(opts, "PaymentReceived")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ProxeusFSContractPaymentReceived)
				if err := _ProxeusFSContract.contract.UnpackLog(event, "PaymentReceived", log); err != nil {
					return err
				}
				event.Raw = log
